...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_myDebug_t, stringdata) + ofs \
...
const QMetaObject myDebug::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_myDebug.data,
      qt_meta_data_myDebug,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *myDebug::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_myDebug.stringdata))
        return static_cast<void*>(const_cast< myDebug*>(this));
